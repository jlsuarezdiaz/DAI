...
SECRET_KEY = 'ovh*)_p!sykkpf*s_&(tdcap#$p5dye&0jxengvqo)x-(hbl6v'
...
LOGIN_REDIRECT_URL = '/restaurants/'  # The page you want users to arrive at after they successful log in
